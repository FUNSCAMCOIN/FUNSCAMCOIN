...
#if defined(NDEBUG)
# error "FUNSCAMCOIN cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x05b487de7b37eaaf8ef790cd1389bd209633109f00a4056369852874f218e9ba");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // FUNSCAMCOIN: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FUNSCAMCOIN Signed Message:\n";
...
{
    // FUNSCAMCOIN: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // FUNSCAMCOIN: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FUNSCAMCOIN: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x05b487de7b37eaaf8ef790cd1389bd209633109f00a4056369852874f218e9ba");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1436895612, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "14/Jul/2015 FUNSCAMCOIN";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1436895612;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1575525;
        ...
        assert(block.hashMerkleRoot == uint256("0x04098c29f8bbe9fb4771e4f7881e94a48f0e0ef292a5f745c9ab19420da5379e"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // FUNSCAMCOIN: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FUNSCAMCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FUNSCAMCOINMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static FUNSCAMCOINMiner(CWallet *pwallet)
{
    printf("FUNSCAMCOINMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("funscamcoin-miner");
    ...
    try { loop {
        ...
        printf("Running FUNSCAMCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FUNSCAMCOINMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&FUNSCAMCOINMiner, pwallet));
}
